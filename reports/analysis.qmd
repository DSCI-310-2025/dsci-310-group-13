...
author: "(fill in your names) Yuexiang Ni"
format:
  html:
...
```{r create train/test split, echo=FALSE}
...
```{r EDA create scatter plot, echo=FALSE}
...
```{r Predict on test data, echo=FALSE}
...
```{r Visualization of Confusion Matrix, echo=FALSE}
predicted_classes <- predict(ordinal_model, newdata = knowledge_test_data)
...
```{r Visualization of Feature Importance, echo=FALSE}
